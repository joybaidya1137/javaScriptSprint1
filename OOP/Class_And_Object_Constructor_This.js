...
class car{
   ...
   /*
   1.constructor: object বানানোর সময় property initialize
...
👉constructor ছাড়া হলে সব object একই default মান পেতো।
👉 constructor থাকলে object বানানোর সময় ভিন্ন ভিন্ন মান দেওয়া যায়।
   */
...
//👉 Class থেকে যখন new keyword ব্যবহার করে কিছু বানানো হয় → সেটাই হলো Object (বা Instance)।
//Object এর কাজ হলো → Data রাখা (Property) + Functionality দেওয়া (Method)।
//অর্থাৎ object হলো বাস্তব জিনিসের digital version, যেটা data রাখে আর কাজ করে।
//👉 Object এর property থাকে, যেখানে data রাখা হয়।
//Class = Design (Car এর নকশা and Object = আসল গাড়ি (Toyota Corolla, Honda Civic)
//Class হলো design, আর সেই design থেকে তৈরি জিনিসটাই হলো Object।
// Class (Blueprint) → new → Object (Instance)
//👉 Class থেকে যখন new keyword ব্যবহার করে কিছু বানানো হয় → সেটাই হলো Object (বা Instance)।


const obj = new car("Toyota", "Corolla"); // Object 1
const obj1 = new car("Honda", "Civic");   // Object 2
...
//Class = blueprint, Constructor = initialization system, Object = বাস্তব জিনিস (instance)।
...
/*
 👉 this হলো একটা special keyword যেটা সবসময় current object কে refer করে।
মানে — তুমি যদি কোনো object এর ভেতরে property বা method access করতে চাও, তখন this ব্যবহার করো।

🔹 কেন দরকার?
যখন তুমি class এর ভেতরে property define করো, তখন constructor বা method এর ভেতরে সেই property access করার জন্য this দরকার হয়।
কারণ constructor/method জানে না কোন object এর কথা বলা হচ্ছে — this সেটাই বলে দেয়।

 */


      //Constructor এ: this = নতুন object
     //Method এ: this = caller object
    // Constructor এর ভেতরে this = নতুন object বানানো হচ্ছে যেটা, সেটাই।
   // Method এর ভেতরে this = যে object method কে call করছে, সেটাই।


   /**
       1.this হলো special keyword → object-oriented programming এ ব্যবহার হয়।
       2.this সবসময় যে object method বা constructor কে call করে, সেই object কে নির্দেশ করে।

       3.Constructor এর ভেতরে:
            this = নতুন তৈরি হওয়া object
            Property/variable initialize করতে ব্যবহার হয়
